...
class FetchDetallecompra {
  var data = [];
    List<Detallecompra> results = [];
  //String fetchurl = 'http://localhost/prueba/detallecompra.php?numero_compra_dc=';
  String fetchurl = "https://tesisagus.000webhostapp.com/detallecompra.php?numero_compra=";

  Future<List<Detallecompra>>getDetalleList(String param, {String? query} ) async {
    ...
    try {
      if (response.statusCode == 200) {
       ...
       results = data.map((e) => Detallecompra.fromJson(e)).toList();
